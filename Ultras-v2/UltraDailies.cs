...
public class UltraDailies
{
    ...
    public List<IOption> Options = new()
    {
        ...
        new Option<string>("Class1", "Class 1", "Preset class 1 to auto-equip before the fights.", ""),
        new Option<string>("Class2", "Class 2", "Preset class 2 to auto-equip before the fights.", ""),
        new Option<string>("Class3", "Class 3", "Preset class 3 to auto-equip before the fights.", ""),
        new Option<string>("Class4", "Class 4", "Preset class 4 to auto-equip before the fights.", ""),
        new Option<string>("Class5", "Class 5", "Preset class 5 to auto-equip before the fights.", ""),
        new Option<string>("Class6", "Class 6", "Preset class 6 to auto-equip before the fights.", ""),
        new Option<string>("Class7", "Class 7", "Preset class 7 to auto-equip before the fights.", ""),
    ...
    void EquipPresetClasses()
    {
        ...
        Ultra.EquipClassSync(classSlots, armySize, "dailies_class-v2.sync", allowDuplicates);
    }
